...
<html>
    ...
    <body>
        ...
        <div id="show-province" class="content scaffold-show" role="main">
            ...
            <f:display bean="province" />
            <g:form resource="${this.province}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.province}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
