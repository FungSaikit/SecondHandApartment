...
<html>
    ...
    <body>
        ...
        <div id="show-agent" class="content scaffold-show" role="main">
            ...
            <f:display bean="agent" />
            <g:form resource="${this.agent}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.agent}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
